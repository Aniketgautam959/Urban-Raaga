...
export const artists: Artist[] = [
  {
    ...
    bestFor: [
      { category: "Weddings (Primary Focus)", events: ["Sangeet & Mehendi", "Reception & Cocktail", "Bridal entry performances"] },
      { category: "Corporate Events", events: ["Office parties", "Brand events", "Formal gatherings"] },
      { category: "Private Parties", events: ["House parties", "Birthday celebrations"] }
    ],
    pricing: [

    ...
    <section className="py-24 bg-[#0B090F] relative overflow-hidden flex flex-col items-center">
      ...
      <div className="text-center mb-16 relative z-10 w-full max-w-4xl px-4">
        <motion.h2 
          ...
          viewport={{ once: true }}
          className="text-5xl md:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-pink-500 via-rose-400 to-orange-400 bg-clip-text text-transparent mb-2 pb-2 tracking-tight"
        >
          Our Clients
        </motion.h2>
        ...
        >
          <span className="text-pink-300 text-3xl md:text-4xl tracking-wide block relative z-10" style={{ fontFamily: "'Caveat', cursive" }}>
            Happy clients, Happy us
          </span>
          {/* Hand drawn arrow approximation */}
          <svg className="absolute -right-16 top-4 w-16 h-16 text-pink-400 opacity-80" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">

      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link
            ...
            className="group flex items-center gap-2 bg-white/15 hover:bg-white/25 backdrop-blur border border-white/30 text-white font-bold px-8 py-3.5 rounded-full text-sm transition-all duration-200 hover:scale-105 focus:outline-none"
          >
